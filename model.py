...
def run_engine():
    ...
    potgres_database = 'postgresql+psycopg2://kts_user:kts_pass@localhost:5432/kts'
...
def add_data_sqlalchemy(url, stars, fork, last_commit, last_release):
    ...
    # class ParseData:
    #     id:             Union[int, Column]
    #     added_at:       Optional[Union[str, Column]]
    #     url:            Optional[Union[str, Column]]
    #     stars:          Optional[Union[str, Column]]
    #     fork:           Optional[Union[str, Column]]
    #     last_commit:    Optional[Union[str, Column]]
    #     last_release:   Optional[Union[str, Column]]
